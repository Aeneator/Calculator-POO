...
int CalculationProcessor::numberPrecision = 4;

int CalculationProcessor::getNumberPrecision() {
    return numberPrecision;
}

void CalculationProcessor::setNumberPrecision(int newPrecision) {
    numberPrecision = newPrecision;
}

void CalculationProcessor::insideParenthesis(char* input, char* selection, int& lastOpenParenthesis, int& firstClosedParanthesis) {
...
void CalculationProcessor::solveInOrder(char* str) {
...
void CalculationProcessor::replace(char* str, int start, int end, double replacement) {
...
double CalculationProcessor::charArrayToDouble(char* charArray) {
    return stod(charArray);
}

void CalculationProcessor::doubleToCharArray(double doubleValue, char* charArray) {
    char precision[10] , temp[10]; precision[0] = '\0'; temp[0] = '\0';
    strcat_s(precision, 10, "%.");
    sprintf_s(temp,10, "%d", getNumberPrecision());
...
void CalculationProcessor::calculateSingleOperation(const char operationSymbol, char* str, int& length) {
...
void CalculationProcessor::selectNumberToTheRight(char* str, char* result, int pivot, int& rightIndex) {
...
void CalculationProcessor::selectNumberToTheLeft(char* str, char* result, int pivot, int& leftIndex) {
    leftIndex = 0;
...
bool CalculationProcessor::isThisCharPartOfNumber(char c) {
